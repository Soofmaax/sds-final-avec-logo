...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-cream/95 backdrop-blur-md border-b border-rose-powder/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center space-x-2 group">
            <Image 
              src="/logo-sds-final.png" 
              alt="SDS - Services de Développement Sur-Mesure" 
              width={120} 
              height={40}
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-charcoal hover:text-magenta transition-colors font-medium">
              Accueil
            </Link>
            <Link href="/services" className="text-charcoal hover:text-magenta transition-colors font-medium">
              Services
            </Link>
            <Link href="/portfolio" className="text-charcoal hover:text-magenta transition-colors font-medium">
              Portfolio
            </Link>
            <Link href="/about" className="text-charcoal hover:text-magenta transition-colors font-medium">
              À propos
            </Link>
            <Link href="/contact" className="text-charcoal hover:text-magenta transition-colors font-medium">
              Contact
            </Link>
          </nav>
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <div className="flex items-center space-x-2">
                <Link href="/dashboard">
                  <Button variant="ghost" size="icon" className="hover:bg-rose-powder/20 hover:text-magenta">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-rose-powder/20">
